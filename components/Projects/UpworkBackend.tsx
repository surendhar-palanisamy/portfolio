      ...
      >
        <VStack>
          ...
          <HStack pt={["", "", "", "5"]}>
            ...
            <Link
              isExternal
              href="https://github.com/surendhar-palanisamy/clone-backend"
        ...
        <Stack>
          <Text fontWeight={"semibold"} fontSize={"xl"}>
            Freelance Work Search portal
          </Text>
          <Text w={["", "", "300px", "300px"]}>
            Website built for the online community to find and outsource jobs
            which can handle high webiste load and efficiently manage tasks
          </Text>
          <Grid
            w={["", "", "300px", "300px"]}
            gap={3}
