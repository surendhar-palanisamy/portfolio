      ...
      >
        <VStack>
          ...
          <HStack>
            <Link
              isExternal
              href="https://phanox-beta.vercel.app/"
              _hover={{ decoration: "none" }}
            >
              <Button size={"sm"} leftIcon={<CgWebsite />}>
                {" "}
                Demo
              </Button>
            </Link>
            <Link
              isExternal
              href="https://github.com/surendhar-palanisamy/Phanox"
              _hover={{ decoration: "none" }}
            >
              <Button size={"sm"} leftIcon={<FaGithubAlt />}>
                Github
              </Button>
            </Link>
          </HStack>
        ...
        <Stack>
          ...
          <Text w={["", "", "300px", "300px"]} pb={["", "", "", "10"]}>
            Modern Ecommerce website to buy tech online with checkout,Stripe
            payment integration , shipping facilites and live banner updates
          </Text>
          <Grid
            w={["", "", "300px", "300px"]}
            gap={3}
